  ...
  return (
    <div className="space-y-1">
      {files.map((file, index) => (
        <div
          key={file.name}
          className={`flex items-center p-3 rounded-lg bg-white/30 dark:bg-slate-800/30 border border-purple-200/50 dark:border-purple-500/50 backdrop-blur-[10px] hover:bg-white/50 dark:hover:bg-slate-800/50 transition-all duration-200 cursor-pointer ${
